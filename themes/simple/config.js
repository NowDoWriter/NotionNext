const CONFIG = {
  ...
  // SIMPLE_LOGO_DESCRIPTION: process.env.NEXT_PUBLIC_THEME_SIMPLE_LOGO_DESCRIPTION || '<div>数字技术爱好者<br/>/持续学习者<br/>/码字工</div>',

  SIMPLE_AUTHOR_LINK: process.env.NEXT_PUBLIC_AUTHOR_LINK || 'http://www.xuyuhui.net',
